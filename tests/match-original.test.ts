...
const options = {
  matchFullText: 'original' as const,
};

test('should returns orginal English', (t) => {
  t.deepEqual(simplePinyin('Hello world', options), ['H', 'e', 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', 'd']);
});
...
test('should return mixed Pinyin and English including symbol', (t) => {
  t.deepEqual(simplePinyin('你好，simplePinyin', options), ['ni', 'hao', '，', 's', 'i', 'm', 'p', 'l', 'e', 'P', 'i', 'n', 'y', 'i', 'n']);
});
